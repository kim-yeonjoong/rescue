    ...
    <section className="px-4 py-24 md:py-32">
      <div className="mx-auto max-w-6xl">
        <BlurFade delay={0} inView>
          <div className="rounded-xl border border-white/10 bg-[#18181b] p-10 text-center">
            <h2 className="text-3xl font-bold tracking-tight text-[#fafafa] sm:text-4xl mb-4">
              Community
            </h2>
            <p className="mx-auto max-w-xl text-[#a1a1aa] leading-relaxed mb-8">
            ...
            <div className="mb-8 flex items-center justify-center">
              <div className="flex -space-x-3">
                {CONTRIBUTORS.map((c) => (
                  <div
                    key={c.initials}
                    className={`flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#18181b] text-xs font-bold text-white ${c.color}`}
                  >
                    {c.initials}
                  </div>
                ))}
